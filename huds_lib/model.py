...
def _build_final_message_prompt(meal_plan: Dict, nutrition_report: Dict, meal_type: str, user_prefs: str) -> str:
    ...
    return (
        f"Compose a concise, friendly explanation of the recommended {meal_header} based on HUDS menu.\n"
        f"Explain why this combination is nutritionally balanced and how it respects the user's preferences.\n"
        f"IMPORTANT: Include specific, practical quantities like '2 scoops of oatmeal', '1 bowl of fruit', '3 pieces of toast', etc.\n"
        f"Structure: 1-2 short paragraphs explaining the meal choice, followed by a bulleted list with specific serving measurements.\n"
        f"Do NOT include any JSON in the output. Make quantities actionable and specific.\n"
        f"User preferences: {user_prefs}\n"
